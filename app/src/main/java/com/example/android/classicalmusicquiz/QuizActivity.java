...
public class QuizActivity extends AppCompatActivity implements View.OnClickListener, ExoPlayer.EventListener {
    ...
    private void showNotification(PlaybackStateCompat state) {
        ...
        NotificationCompat.Action restartAction = new android.support.v4.app.NotificationCompat.Action(
                ...
                // A broadcasting pending intent, with a media action.  This
                // requires that a 'receiver' is defined in our manifest!
                MediaButtonReceiver.buildMediaButtonPendingIntent(
                        this,
                        PlaybackStateCompat.ACTION_SKIP_TO_PREVIOUS
                )
        ...
        // Pending intent to launch QuizActivity when notification is clicked.
        // Launch mode for this activity, as defined in the manifest is "single top",
        // the activity will be brought to the front, instead of being restarted.
        ...
        builder.setContentTitle(getString(R.string.guess))
                ...
                .setSmallIcon(R.drawable.question_mark) // ic_music_note)
    ...
    private void releasePlayer() {
        ...
        // TODO (Exercise TMED.06-3) Video says to do below, but there's no TODO saying to do so!
        // Clear any showing notification when activity is destroyed ...
    ...
    // TODO (Exercise TMED.06-4) Create a receiver to hear actions from the notification dropdown -->
    static public class MediaReceiver extends BroadcastReceiver {
