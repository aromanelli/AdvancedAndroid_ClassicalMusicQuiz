...
public class QuizActivity extends AppCompatActivity implements ExoPlayer.EventListener, View.OnClickListener {

    final static private String TAG = QuizActivity.class.getSimpleName();
    ...
    public void onPlayerStateChanged(boolean playWhenReady, int playbackState) {
        ...
        if (ExoPlayer.STATE_READY == playbackState) {
            if (playWhenReady) {
                // Playing
                Log.i(TAG, "onPlayerStateChanged: Player playing.");
            } else {
                // Paused
                Log.i(TAG, "onPlayerStateChanged: Player paused.");
            }
        }
    }
